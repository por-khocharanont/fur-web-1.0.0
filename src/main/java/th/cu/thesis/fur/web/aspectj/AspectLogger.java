package th.cu.thesis.fur.web.aspectj;
...
public class AspectLogger {
	...
	@Before("execution(* th.cu.thesis.fur.web.controller.*.*(..)) && args(obj,..)")
...
//	@AfterReturning(pointcut="execution(* th.cu.thesis.fur.web.controller.*.*(..))", returning="response")
...
//	@Before("execution(* th.cu.thesis.fur.web.util.RestUtil.exchange(..)) && args(url, method, requestEntity, responseType)")
...
//	@AfterReturning(pointcut="execution(* th.cu.thesis.fur.web.util.RestUtil.exchange(..))", returning="response")
